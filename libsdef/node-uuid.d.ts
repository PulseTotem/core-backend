...
interface UUID {
    ...
    v1(options?: UUIDOptions, buffer?: any, offset?: number): string

    v2(options?: UUIDOptions, buffer?: number[], offset?: number): string
    v2(options?: UUIDOptions, buffer?: any, offset?: number): string

    v3(options?: UUIDOptions, buffer?: number[], offset?: number): string
    v3(options?: UUIDOptions, buffer?: any, offset?: number): string

    v4(options?: UUIDOptions, buffer?: number[], offset?: number): string
    v4(options?: UUIDOptions, buffer?: any, offset?: number): string
}
